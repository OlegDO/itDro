...
export const LESSONS: Lesson[] = [
  ...
  // Lesson 20
  { title : 'Перебирающие методы массивов', link: 'lesson20', type: 'data-structure2', nextPageLink: 'lesson21', previousPageLink: 'lesson19', src: 'https://firebasestorage.googleapis.com/v0/b/itdro-6a5c5.appspot.com/o/lesson20V2.mp4?alt=media&token=4b8322b9-daf8-4849-b810-8a3f7ef20b82'},
  // Lesson 20
